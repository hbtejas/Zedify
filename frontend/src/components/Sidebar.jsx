...
const NAV = [
  ...
  { to: '/network',   label: 'Connect',   icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5V4h-5m-9 16H2V4h5m8 6l-3-3-3 3M8 14l3 3 3-3"/></svg> },
