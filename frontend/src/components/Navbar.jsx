      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* GitHub Contribute (Open Source) */}
            <a
              href="https://github.com/hbtejas/Zedify"
              target="_blank"
              rel="noopener noreferrer"
              className="hidden lg:flex items-center gap-2 px-3 py-1.5 rounded-xl border border-white/5 bg-white/5 transition-all hover:bg-white/10 hover:border-white/20 mr-1"
            >
               ...
               <span className="text-[10px] font-black text-white/40 uppercase tracking-widest">Contribute</span>
            </a>
